...
func TestBuildStyle_UsesLabelBackgroundAndPreviewConfig(t *testing.T) {
	...
	if lightStyle.LabelBackgroundColor != parseLinuxColor(config.RecursiveGridLabelBackgroundColorLight) {
		t.Fatalf("expected light label background color to be resolved from config")
	}
	if lightStyle.SubKeyPreviewTextColor != parseLinuxColor(config.RecursiveGridSubKeyPreviewTextColorLight) {
	...
	if darkStyle.LabelBackgroundColor != parseLinuxColor(config.RecursiveGridLabelBackgroundColorDark) {
		t.Fatalf("expected dark label background color to be resolved from config")
	}
	if darkStyle.SubKeyPreviewTextColor != parseLinuxColor(config.RecursiveGridSubKeyPreviewTextColorDark) {
