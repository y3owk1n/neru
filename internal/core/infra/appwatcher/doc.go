...
// activate, deactivate, front-app switch, menu tracking change, screen change)
...
// observer and a Carbon front-application-switch handler; on other platforms
// the watcher is a no-op until implemented.
package appwatcher
