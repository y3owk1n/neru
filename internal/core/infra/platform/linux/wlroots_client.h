...
int neru_wlr_modifier_event(NeruWlrootsClient *c, const char *modifier,
                            int is_down);
int neru_wlr_get_cursor(NeruWlrootsClient *c, int *x, int *y);
int neru_wlr_screen_count(NeruWlrootsClient *c);
int neru_wlr_screen_info(NeruWlrootsClient *c, int idx, int *x, int *y, int *w,
                         int *h, char *name_out, int name_len);
