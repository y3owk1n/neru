...
WL_PRIVATE const struct wl_interface ext_foreign_toplevel_list_v1_interface = {
    "ext_foreign_toplevel_list_v1", 1, 2, ext_foreign_toplevel_list_v1_requests, 2, ext_foreign_toplevel_list_v1_events,
};
...
WL_PRIVATE const struct wl_interface ext_foreign_toplevel_handle_v1_interface = {
    ...
    ext_foreign_toplevel_handle_v1_requests, 5, ext_foreign_toplevel_handle_v1_events,
};
