...
WL_PRIVATE const struct wl_interface ext_workspace_manager_v1_interface = {
    "ext_workspace_manager_v1", 1, 2, ext_workspace_manager_v1_requests, 4, ext_workspace_manager_v1_events,
};
...
static const struct wl_message ext_workspace_group_handle_v1_events[] = {
    {"capabilities", "u", ext_workspace_v1_types + 0},    {"output_enter", "o", ext_workspace_v1_types + 3},
    {"output_leave", "o", ext_workspace_v1_types + 4},    {"workspace_enter", "o", ext_workspace_v1_types + 5},
    {"workspace_leave", "o", ext_workspace_v1_types + 6}, {"removed", "", ext_workspace_v1_types + 0},
};

WL_PRIVATE const struct wl_interface ext_workspace_group_handle_v1_interface = {
    "ext_workspace_group_handle_v1",        1, 2,
    ext_workspace_group_handle_v1_requests, 6, ext_workspace_group_handle_v1_events,
};

static const struct wl_message ext_workspace_handle_v1_requests[] = {
    {"destroy", "", ext_workspace_v1_types + 0},    {"activate", "", ext_workspace_v1_types + 0},
    {"deactivate", "", ext_workspace_v1_types + 0}, {"assign", "o", ext_workspace_v1_types + 7},
    {"remove", "", ext_workspace_v1_types + 0},
};

static const struct wl_message ext_workspace_handle_v1_events[] = {
    {"id", "s", ext_workspace_v1_types + 0},           {"name", "s", ext_workspace_v1_types + 0},
    {"coordinates", "a", ext_workspace_v1_types + 0},  {"state", "u", ext_workspace_v1_types + 0},
    {"capabilities", "u", ext_workspace_v1_types + 0}, {"removed", "", ext_workspace_v1_types + 0},
};

WL_PRIVATE const struct wl_interface ext_workspace_handle_v1_interface = {
    "ext_workspace_handle_v1", 1, 5, ext_workspace_handle_v1_requests, 6, ext_workspace_handle_v1_events,
};
