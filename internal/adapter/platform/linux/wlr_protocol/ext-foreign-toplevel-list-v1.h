...
struct ext_foreign_toplevel_list_v1_listener {
	 ...
	 * ext_foreign_toplevel_list_v1.destroy for more information.
	 *
	 * The compositor must not send any more toplevel events after this
	 * event.
	 */
	void (*finished)(void *data, struct ext_foreign_toplevel_list_v1 *ext_foreign_toplevel_list_v1);
};
...
static inline int ext_foreign_toplevel_list_v1_add_listener(
	...
	return wl_proxy_add_listener((struct wl_proxy *)ext_foreign_toplevel_list_v1, (void (**)(void))listener, data);
}
...
static inline void ext_foreign_toplevel_list_v1_set_user_data(
    struct ext_foreign_toplevel_list_v1 *ext_foreign_toplevel_list_v1, void *user_data) {
...
static inline uint32_t ext_foreign_toplevel_list_v1_get_version(
    struct ext_foreign_toplevel_list_v1 *ext_foreign_toplevel_list_v1) {
...
static inline void ext_foreign_toplevel_list_v1_stop(
	...
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_foreign_toplevel_list_v1, EXT_FOREIGN_TOPLEVEL_LIST_V1_STOP, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_foreign_toplevel_list_v1), 0);
}
...
static inline void ext_foreign_toplevel_list_v1_destroy(
    struct ext_foreign_toplevel_list_v1 *ext_foreign_toplevel_list_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_foreign_toplevel_list_v1, EXT_FOREIGN_TOPLEVEL_LIST_V1_DESTROY, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_foreign_toplevel_list_v1), WL_MARSHAL_FLAG_DESTROY);
}
...
struct ext_foreign_toplevel_handle_v1_listener {
	 ...
	 */
	void (*closed)(void *data, struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1);
	/**
	 ...
	 */
	void (*done)(void *data, struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1);
	/**
	 * title change
	 *
	 ...
	 */
	void (*title)(void *data, struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1, const char *title);
	/**
	 * app_id change
	 *
	 ...
	 */
	void (*app_id)(
	    void *data, struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1, const char *app_id);
	/**
	 ...
	 * created.
	 *
	 * The identifier must be unique per toplevel and its handles. Two
	 ...
	 */
	void (*identifier)(
	    void *data, struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1, const char *identifier);
};
...
static inline int ext_foreign_toplevel_handle_v1_add_listener(
	...
	return wl_proxy_add_listener((struct wl_proxy *)ext_foreign_toplevel_handle_v1, (void (**)(void))listener, data);
}
...
/** @ingroup iface_ext_foreign_toplevel_handle_v1 */
static inline void ext_foreign_toplevel_handle_v1_set_user_data(
    struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1, void *user_data) {
	wl_proxy_set_user_data((struct wl_proxy *)ext_foreign_toplevel_handle_v1, user_data);
}

/** @ingroup iface_ext_foreign_toplevel_handle_v1 */
static inline void *ext_foreign_toplevel_handle_v1_get_user_data(
    struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1) {
	return wl_proxy_get_user_data((struct wl_proxy *)ext_foreign_toplevel_handle_v1);
}

static inline uint32_t ext_foreign_toplevel_handle_v1_get_version(
    struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1) {
...
static inline void ext_foreign_toplevel_handle_v1_destroy(
    struct ext_foreign_toplevel_handle_v1 *ext_foreign_toplevel_handle_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_foreign_toplevel_handle_v1, EXT_FOREIGN_TOPLEVEL_HANDLE_V1_DESTROY, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_foreign_toplevel_handle_v1), WL_MARSHAL_FLAG_DESTROY);
}
