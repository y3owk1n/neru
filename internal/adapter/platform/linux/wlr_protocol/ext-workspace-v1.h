...
struct ext_workspace_manager_v1_listener {
	 ...
	 */
	void (*done)(void *data, struct ext_workspace_manager_v1 *ext_workspace_manager_v1);
	/**
	 ...
	 */
	void (*finished)(void *data, struct ext_workspace_manager_v1 *ext_workspace_manager_v1);
};
...
static inline int ext_workspace_manager_v1_add_listener(
    struct ext_workspace_manager_v1 *ext_workspace_manager_v1, const struct ext_workspace_manager_v1_listener *listener,
    void *data) {
	return wl_proxy_add_listener((struct wl_proxy *)ext_workspace_manager_v1, (void (**)(void))listener, data);
}
...
/** @ingroup iface_ext_workspace_manager_v1 */
static inline void ext_workspace_manager_v1_set_user_data(
    struct ext_workspace_manager_v1 *ext_workspace_manager_v1, void *user_data) {
	wl_proxy_set_user_data((struct wl_proxy *)ext_workspace_manager_v1, user_data);
}

/** @ingroup iface_ext_workspace_manager_v1 */
static inline void *ext_workspace_manager_v1_get_user_data(struct ext_workspace_manager_v1 *ext_workspace_manager_v1) {
	return wl_proxy_get_user_data((struct wl_proxy *)ext_workspace_manager_v1);
}

static inline uint32_t ext_workspace_manager_v1_get_version(struct ext_workspace_manager_v1 *ext_workspace_manager_v1) {
	return wl_proxy_get_version((struct wl_proxy *)ext_workspace_manager_v1);
}

/** @ingroup iface_ext_workspace_manager_v1 */
static inline void ext_workspace_manager_v1_destroy(struct ext_workspace_manager_v1 *ext_workspace_manager_v1) {
 ...
 */
static inline void ext_workspace_manager_v1_commit(struct ext_workspace_manager_v1 *ext_workspace_manager_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_manager_v1, EXT_WORKSPACE_MANAGER_V1_COMMIT, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_manager_v1), 0);
}
 ...
 */
static inline void ext_workspace_manager_v1_stop(struct ext_workspace_manager_v1 *ext_workspace_manager_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_manager_v1, EXT_WORKSPACE_MANAGER_V1_STOP, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_manager_v1), 0);
}
...
struct ext_workspace_group_handle_v1_listener {
	 ...
	 */
	void (*capabilities)(
	    void *data, struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1, uint32_t capabilities);
	/**
	 ...
	 */
	void (*output_enter)(
	    void *data, struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1, struct wl_output *output);
	/**
	...
	void (*workspace_enter)(
	    void *data, struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1,
	    struct ext_workspace_handle_v1 *workspace);
	/**
	 ...
	 * workspace group.
	 */
	void (*removed)(void *data, struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1);
};
...
static inline int ext_workspace_group_handle_v1_add_listener(
	...
	return wl_proxy_add_listener((struct wl_proxy *)ext_workspace_group_handle_v1, (void (**)(void))listener, data);
}
...
/** @ingroup iface_ext_workspace_group_handle_v1 */
static inline void ext_workspace_group_handle_v1_set_user_data(
    struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1, void *user_data) {
	wl_proxy_set_user_data((struct wl_proxy *)ext_workspace_group_handle_v1, user_data);
}

/** @ingroup iface_ext_workspace_group_handle_v1 */
static inline void *ext_workspace_group_handle_v1_get_user_data(
    struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1) {
	return wl_proxy_get_user_data((struct wl_proxy *)ext_workspace_group_handle_v1);
}

static inline uint32_t ext_workspace_group_handle_v1_get_version(
    struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1) {
 ...
 */
static inline void ext_workspace_group_handle_v1_create_workspace(
    struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1, const char *workspace) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_group_handle_v1, EXT_WORKSPACE_GROUP_HANDLE_V1_CREATE_WORKSPACE, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_group_handle_v1), 0, workspace);
}
 ...
 */
static inline void ext_workspace_group_handle_v1_destroy(
    struct ext_workspace_group_handle_v1 *ext_workspace_group_handle_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_group_handle_v1, EXT_WORKSPACE_GROUP_HANDLE_V1_DESTROY, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_group_handle_v1), WL_MARSHAL_FLAG_DESTROY);
}
...
struct ext_workspace_handle_v1_listener {
	 ...
	 */
	void (*id)(void *data, struct ext_workspace_handle_v1 *ext_workspace_handle_v1, const char *id);
	/**
	 ...
	 */
	void (*name)(void *data, struct ext_workspace_handle_v1 *ext_workspace_handle_v1, const char *name);
	/**
	 ...
	 */
	void (*coordinates)(
	    void *data, struct ext_workspace_handle_v1 *ext_workspace_handle_v1, struct wl_array *coordinates);
	/**
	 ...
	 */
	void (*state)(void *data, struct ext_workspace_handle_v1 *ext_workspace_handle_v1, uint32_t state);
	/**
	 * compositor capabilities
	 *
	 * This event advertises the capabilities supported by the
	 ...
	 * @param capabilities capabilities
	 */
	void (*capabilities)(void *data, struct ext_workspace_handle_v1 *ext_workspace_handle_v1, uint32_t capabilities);
	/**
	 ...
	 */
	void (*removed)(void *data, struct ext_workspace_handle_v1 *ext_workspace_handle_v1);
};
...
static inline int ext_workspace_handle_v1_add_listener(
    struct ext_workspace_handle_v1 *ext_workspace_handle_v1, const struct ext_workspace_handle_v1_listener *listener,
    void *data) {
	return wl_proxy_add_listener((struct wl_proxy *)ext_workspace_handle_v1, (void (**)(void))listener, data);
}
...
/** @ingroup iface_ext_workspace_handle_v1 */
static inline void ext_workspace_handle_v1_set_user_data(
    struct ext_workspace_handle_v1 *ext_workspace_handle_v1, void *user_data) {
	wl_proxy_set_user_data((struct wl_proxy *)ext_workspace_handle_v1, user_data);
}

/** @ingroup iface_ext_workspace_handle_v1 */
static inline void *ext_workspace_handle_v1_get_user_data(struct ext_workspace_handle_v1 *ext_workspace_handle_v1) {
	return wl_proxy_get_user_data((struct wl_proxy *)ext_workspace_handle_v1);
}

static inline uint32_t ext_workspace_handle_v1_get_version(struct ext_workspace_handle_v1 *ext_workspace_handle_v1) {
 ...
 * the destruction of the object.
 */
static inline void ext_workspace_handle_v1_destroy(struct ext_workspace_handle_v1 *ext_workspace_handle_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_handle_v1, EXT_WORKSPACE_HANDLE_V1_DESTROY, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_handle_v1), WL_MARSHAL_FLAG_DESTROY);
}
 ...
 * group.
 */
static inline void ext_workspace_handle_v1_activate(struct ext_workspace_handle_v1 *ext_workspace_handle_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_handle_v1, EXT_WORKSPACE_HANDLE_V1_ACTIVATE, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_handle_v1), 0);
}
 ...
 */
static inline void ext_workspace_handle_v1_deactivate(struct ext_workspace_handle_v1 *ext_workspace_handle_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_handle_v1, EXT_WORKSPACE_HANDLE_V1_DEACTIVATE, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_handle_v1), 0);
}
 ...
 */
static inline void ext_workspace_handle_v1_assign(
    struct ext_workspace_handle_v1 *ext_workspace_handle_v1, struct ext_workspace_group_handle_v1 *workspace_group) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_handle_v1, EXT_WORKSPACE_HANDLE_V1_ASSIGN, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_handle_v1), 0, workspace_group);
}
 ...
 */
static inline void ext_workspace_handle_v1_remove(struct ext_workspace_handle_v1 *ext_workspace_handle_v1) {
	wl_proxy_marshal_flags(
	    (struct wl_proxy *)ext_workspace_handle_v1, EXT_WORKSPACE_HANDLE_V1_REMOVE, NULL,
	    wl_proxy_get_version((struct wl_proxy *)ext_workspace_handle_v1), 0);
}
