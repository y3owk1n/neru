...
//
// What it remembers is bounded by what is measured. Label alphabets and sizes
// come from configuration, and monitor names from the displays attached. A
// failure is not remembered, so a text layer that was briefly unusable is
// asked again.
