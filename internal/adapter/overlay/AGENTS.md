...
- **`originOffset` applies selectively**: grid, recursive-grid, and hints arrive screen-local and get the offset; absolute draws (badges, monitor_select, click indicator) must not.
