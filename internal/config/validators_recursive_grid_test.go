...
func TestConfig_ValidateRecursiveGrid(t *testing.T) {
	tests := []struct {
		...
		// --- SubKeyPreviewAutohideThreshold tests ---
		{
			name: "recursive_grid with negative sub_key_preview_autohide_threshold - invalid",
			config: config.Config{
				RecursiveGrid: config.RecursiveGridConfig{
					Enabled:       true,
					GridCols:      2,
					...
					UI: config.RecursiveGridUI{
						...
						TextColorDark:                  "#0000FF",
						SubKeyPreviewFontSize:          6,
						SubKeyPreviewAutohideThreshold: -1.0,
					},
				},
			},
			wantErr: true,
		...
		{
			name: "recursive_grid with zero sub_key_preview_autohide_threshold (disable autohide) - valid",
			config: config.Config{
				RecursiveGrid: config.RecursiveGridConfig{
					Enabled:       true,
					GridCols:      2,
					...
					UI: config.RecursiveGridUI{
						...
						TextColorDark:                  "#0000FF",
						SubKeyPreviewFontSize:          6,
						SubKeyPreviewAutohideThreshold: 0,
					},
				},
			},
			wantErr: false,
		...
		{
			name: "recursive_grid with positive sub_key_preview_autohide_threshold - valid",
			config: config.Config{
				RecursiveGrid: config.RecursiveGridConfig{
					Enabled:       true,
					GridCols:      2,
					...
					UI: config.RecursiveGridUI{
						...
						TextColorDark:                  "#0000FF",
						SubKeyPreviewFontSize:          6,
						SubKeyPreviewAutohideThreshold: 2.5,
					},
				},
			},
			wantErr: false,
