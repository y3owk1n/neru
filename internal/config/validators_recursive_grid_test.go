...
func TestConfig_ValidateRecursiveGrid(t *testing.T) {
	tests := []struct {
		...
		{
			name: "recursive_grid with valid auto_exit_actions",
			config: config.Config{
				RecursiveGrid: config.RecursiveGridConfig{
					Enabled:         true,
					GridCols:        2,
		...
		{
			name: "recursive_grid with empty auto_exit_actions",
			config: config.Config{
				RecursiveGrid: config.RecursiveGridConfig{
					Enabled:         true,
					GridCols:        2,
		...
		{
			name: "recursive_grid with invalid auto_exit_actions",
			config: config.Config{
				RecursiveGrid: config.RecursiveGridConfig{
					Enabled:         true,
					GridCols:        2,
					...
					HighlightColor:  "#00FF00",
					LabelColor:      "#0000FF",
					AutoExitActions: []string{"left_click", "invalid_action"},
				},
			},
			wantErr: true,
		},
		{
			name: "recursive_grid with move_mouse in auto_exit_actions - invalid",
			config: config.Config{
				RecursiveGrid: config.RecursiveGridConfig{
					Enabled:         true,
					GridCols:        2,
		...
		{
			name: "recursive_grid with all valid click auto_exit_actions",
			config: config.Config{
				RecursiveGrid: config.RecursiveGridConfig{
					Enabled:         true,
					GridCols:        2,
