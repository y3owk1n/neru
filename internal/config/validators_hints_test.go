...
func TestValidateHints(t *testing.T) {
	tests := []struct {
		...
		{
			name: "valid hints config with auto_exit_actions",
			config: config.Config{
				Hints: config.HintsConfig{
					HintCharacters:    "abcd",
					BackgroundColor:   "#FFFFFF",
		...
		{
			name: "valid hints config with empty auto_exit_actions",
			config: config.Config{
				Hints: config.HintsConfig{
					HintCharacters:    "abcd",
					BackgroundColor:   "#FFFFFF",
		...
		{
			name: "valid hints config with all direct key binding actions in auto_exit_actions",
			config: config.Config{
				Hints: config.HintsConfig{
					HintCharacters:    "abcd",
					BackgroundColor:   "#FFFFFF",
		...
		{
			name: "invalid hints auto_exit_actions with unknown action",
			config: config.Config{
				Hints: config.HintsConfig{
					HintCharacters:    "abcd",
					BackgroundColor:   "#FFFFFF",
					...
					MaxDepth:          50,
					ParallelThreshold: 20,
					AutoExitActions:   []string{"left_click", "unknown_action"},
				},
			},
			wantErr: true,
		},
		{
			name: "invalid hints auto_exit_actions with scroll (IPC-only)",
			config: config.Config{
				Hints: config.HintsConfig{
					HintCharacters:    "abcd",
					BackgroundColor:   "#FFFFFF",
		...
		{
			name: "invalid hints auto_exit_actions with move_mouse (IPC-only)",
			config: config.Config{
				Hints: config.HintsConfig{
					HintCharacters:    "abcd",
					BackgroundColor:   "#FFFFFF",
